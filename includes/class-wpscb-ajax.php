...
class WPSCB_Ajax {
    ...
    public function wpscb_save_contact() {
        ...
        // Sanitize JSON availability data
        $availability_raw = isset( $_POST['availability'] ) ? sanitize_text_field( wp_unslash( $_POST['availability'] ) ) : '';
    ...
    public function wpscb_save_advanced_settings() {
        ...
        $adv = array(
            ...
            'button_icon_svg'        => isset( $_POST['button_icon_svg'] ) ? wp_unslash( $_POST['button_icon_svg'] ) : '',
            ...
            'button_border_radius'   => isset( $_POST['button_border_radius'] ) ? absint( $_POST['button_border_radius'] ) : 16,
